...
export default function page() {
    ...
    return (
        <>
            ...
            <div className='text-[rgb(255,255,255)] w-[45%] mt-5 ml-[5%] rounded-xl
                ...
                <form onSubmit={handleSubmit}>
                    <div className='flex flex-col '>
                        ...
                        <input type="text" value={title} onChange={(e) => { setTitle(e.target.value) }}
                            className='border font-bold h-10 pl-4 mt-2 w-[50%]'
                        ...
                        <input type="number" value={rating} onChange={(e) => { setRating(e.target.valueAsNumber) }}
                            className='border font-bold h-10 mt-2 pl-4 w-[15%]'
                            placeholder='8.6' required />
                        <button type='submit' className=' w-[20%] mb-10 text-black h-10 bg-white mt-5 font-bold transition-all duration-500 hover:bg-[rgb(117,227,255)] hover:text-black'>submit</button>
                    </div>
                </form>
            </div>
        </>
