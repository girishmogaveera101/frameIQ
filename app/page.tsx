...
export default function Home() {
  ...
  return (<>
    ...
    <p className="md:text-3xl hidden md:flex text-xl md:mt-2 mt-2 text-center font-light bg-gradient-to-r from-blue-400 via-pink-500 to-green-500 bg-clip-text text-transparent">
